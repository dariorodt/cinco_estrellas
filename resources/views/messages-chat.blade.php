				...
				<div class="col-md-9 col-sm-9 col-xs-12 bg_white">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="chat-frame">
								...
								@foreach ($order->messages as $message)
									<div class="msg-box {{ $message->sender == 'client' ? 'msg-box-rg' : 'msg-box-lf' }}">
										...
										<div class="img-box">
											@if ($message->sender == 'worker')
												<img src="{{ asset($order->worker->profile->image_path) }}" class="user-img">
											@else
												<img src="{{ asset($user->profile->image_path) }}" class="user-img">
											@endif
										</div>
										@if ($message->sender == 'worker')
						...
						<div class="col-md-12 m_t10 m_b30">
							<form action="{{ route('user.message.send', $order) }}" method="POST">
								@csrf
