				...
				<div class="col-md-12 text-center">
					<div class="inner_banner_2_detail">
						...
						<p>
							...
							<i class="fa fa-angle-double-right" aria-hidden="true"></i> Entrar / Registrar
						</p>
					</div>
				</div>
				...
				<div class="col-md-6 col-md-offset-3">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class="active">
							<a href="#registerd" aria-controls="registerd" role="tab" data-toggle="tab">
								Registrar
							</a>
						</li>
					</ul>
						...
						<div class="col-md-6 col-md-offset-3">
							<div class="login-register-bg">
								...
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="heading">
											<h2>Iniciar como <span>Cliente</span></h2>
										</div>
										...
										<form action="{{ route('login') }}" method="POST">
											...
											<div class="form-group">
												<a href="{{ route('worker.login') }}">¿Eres trabajador?</a>
											</div>
											<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-xs-12">
										...
										<form action="{{ route('register') }}" method="POST">
											...
											<div class="form-group">
												<a href="{{ route('login') }}">¿Ya eres usuario? Iniciar sesión</a>
											</div>
										</form>
									</div>
