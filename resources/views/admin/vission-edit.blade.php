				...
				<div class="col-md-12">
					<div class="box box-info">
						...
						<div class="box-body pad">
							<form id="termsForm" action="{{ route('admin.vission.store') }}" method="POST">
								@csrf
								<textarea id="editor1" name="text" rows="10" cols="80">{{ $vission_text }}</textarea>
							</form>
						</div>
					</div>
					<!-- /.box -->
