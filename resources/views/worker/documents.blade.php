...
@section('title', 'Documentos del trabajador')
						...
						<div class="row p_b30">
							<div class="col-md-12">
								<div class="form-group">
									<button onclick="location.href='{{ route('worker.document.upload') }}'">
									...
									<tbody>
										...
										@foreach ($my_documents as $this_document)
											<tr>
												...
												<td>
													<a class="btn btn-info btn-sm" href="{{ route('worker.document.edit', $this_document->id) }}"><i class="fa fa-edit"></i></a>
													<form action="{{ route('worker.document.delete', $this_document->id) }}" method="POST" style="display: inline;">
														@csrf
														@method('DELETE')
